...
def app():
    # title of the app
    st.markdown("Acceso y Datos para Administrativos")
    # Add a sidebar
    ...
    with top[0]:
        ...
        if contraseña == 'administrativo':
            URL = f'https://docs.google.com/spreadsheets/d/1mnqBzFI2doEicBFj3aOS0sN1lX_Sn5TaJw4MYQynEGc/gviz/tq?tqx=out:csv&sheet=Clases'
        elif contraseña == 'familia':
        ...
        elif contraseña == 'profesores':
            URL = f'https://docs.google.com/spreadsheets/d/1mnqBzFI2doEicBFj3aOS0sN1lX_Sn5TaJw4MYQynEGc/gviz/tq?tqx=out:csv&sheet=Profesores'
        else:
